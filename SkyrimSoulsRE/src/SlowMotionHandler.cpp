...
namespace SkyrimSoulsRE
{
	...
	ConsoleRE::BSEventNotifyControl SlowMotionHandler::ProcessEvent(const ConsoleRE::MenuOpenCloseEvent* a_event, ConsoleRE::BSTEventSource<ConsoleRE::MenuOpenCloseEvent>* a_dispatcher)
	{
		uint32_t slowMotionCount = GetSlowMotionCount();
